      ...
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              <li><a href="#" className="hover:text-blue-400">Wide Selection: Explore thousands of curated </a></li>
              <li><a href="#" className="hover:text-blue-400">Quality Assurance: We handpick every item</a></li>
              <li><a href="#" className="hover:text-blue-400"> Competitive Pricing: Our mission is to offer </a></li>
              <li><a href="#" className="hover:text-blue-400">Fast and Reliable Shipping</a></li>
